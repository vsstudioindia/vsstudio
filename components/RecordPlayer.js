    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(to top, rgba(4,4,6,0.85) 0%, rgba(4,4,6,0.08) 60%)',
        }}
      />
...
export default function RecordPlayer() {
  ...
  const [lightboxVideo, setLightboxVideo] =
    useState(null);

  const [lightboxName, setLightboxName] =
    useState('');
        ...
        >
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              background:
                `radial-gradient(circle at center, rgba(${mood.rgb},0.07) 0%, rgba(${mood.rgb},0.04) 38%, rgba(${mood.rgb},0.015) 58%, transparent 70%)`,
            }}
          />
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              animation:
                'haloBreath 4s ease-in-out infinite',
              background:
                `radial-gradient(circle at center, transparent 0%, transparent 35%, rgba(${mood.rgb},0.04) 39%, rgba(${mood.rgb},0.16) 43%, rgba(${mood.rgb},0.22) 46%, rgba(${mood.rgb},0.16) 49%, rgba(${mood.rgb},0.07) 54%, rgba(${mood.rgb},0.02) 61%, transparent 68%)`,
            }}
          />
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              background:
                'linear-gradient(125deg, rgba(255,255,255,0.06) 0%, transparent 38%, rgba(0,0,0,0.22) 100%)',
            }}
          />
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              background:
                'linear-gradient(180deg, #060808 0%, transparent 100%)',
            }}
          />
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              background:
                'linear-gradient(0deg, #060808 0%, transparent 100%)',
            }}
          />
          ...
          <div
            style={{
              ...
              pointerEvents: 'none',
              background:
                'linear-gradient(90deg, transparent 0%, rgba(6,8,8,0.85) 100%)',
            }}
          />
        </div>
        ...
        <div
          style={{
            ...
            padding:
              isMobile
                ? '72px 24px 60px'
                : 'clamp(48px,6vh,80px) 64px clamp(48px,6vh,80px) 48px',
            display: 'flex',
        ...
        >
          ...
          <div
            style={{
              ...
              zIndex: -1,
              background:
                'linear-gradient(90deg, transparent 0%, rgba(6,8,8,0.45) 40%, rgba(6,8,8,0.7) 100%)',
            }}
          />
              ...
              height:
                isMobile
                  ...
                  : mood.couples
                        .length > 3 ||
                    mood.grid6
                    ? 'clamp(360px,42vh,400px)'
                    : 'clamp(240px,30vh,340px)',
              minWidth:
                isMobile
                  ? 'auto'
                  : mood.couples
